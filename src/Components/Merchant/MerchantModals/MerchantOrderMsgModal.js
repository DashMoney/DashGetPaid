...
class MerchantOrderMsgModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      commentInput: '',
 ...
 orderCommentValidate = (comment) => {
  ...
  handleSubmitClick = () => {
      ...
      this.props.handleMerchantOrderMsgSubmit(this.state.commentInput);
      this.props.hideModal();
  };
      ...
      <>
        <Modal show={this.props.isModalShowing} backdropClassName={modalBackdrop} contentClassName={modalBkg}>
          ...
          <Modal.Body>
              ...
              >
                <Form.Label><b>Message for{' '}{this.props.messageStoreOwnerName}{' '} Order</b></Form.Label>
...
export default MerchantOrderMsgModal;
